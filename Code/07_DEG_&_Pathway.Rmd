...
library(Seurat)
library(MAST)
sce <- readH5AD("C:/Users/VARSHA/Documents/rna_seq/GSE279086/bonus/output/GSE279086_celltypist.h5ad")
...
saveRDS(seurat_obj, "C:/Users/VARSHA/Documents/rna_seq/GSE279086/bonus/output/GSE279086_with_celltypist.rds")
...
```{r}
dir.create(
  "C:/Users/VARSHA/Documents/rna_seq/GSE279086/bonus/output/DEG_MAST_T1D_vs_LC",
  recursive = TRUE,
  showWarnings = FALSE
)
...
run_mast_per_celltype_DKD_vs_Healthy <- function(
  ...
  outdir = "C:/Users/VARSHA/Documents/rna_seq/GSE279086/bonus/output/DEG_MAST_T1D_vs_LC",
...
deg_path <- "C:/Users/VARSHA/Documents/rna_seq/GSE279086/bonus/output/DEG_MAST_T1D_vs_LC/"
...
write.csv(
  deg_summary,
  "C:/Users/VARSHA/Documents/rna_seq/GSE279086/bonus/output/DEG_MAST_T1D_vs_LC/DEGsummary_table.csv",
  row.names = FALSE
)
```
